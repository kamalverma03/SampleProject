		...
		<div class="login-card">
			...
			<form action="${pageContext.request.contextPath}/login" method="post">
				<c:if test="${'fail' eq param.auth}">
					<div style="color: red">Incorrect Login/password error.</div>
				</c:if>
				<input type="text" name="userId" value="" placeholder="UserId">
				<input type="password" name="password" value=""
					placeholder="Password"> <input type="submit" name="login"
					class="login login-submit" value="login" /> 
					
			</form>

			<div class="login-help">
				Not yet registered? <a href="/Registration/registration">Sign Up</a>
